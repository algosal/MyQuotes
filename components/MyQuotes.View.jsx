...
export default function MyQuotesDisplay(){
    ...
    let mySelection = 0; 
    let i = 0;
    let [myQuote,setMyQuote] = useState("Hello");  
    ...
    function MyQuotesServiceLoop(){
        ...
        if (i < 25) {           //  if the counter < 10, call the loop function
         ...
         MyQuotesServiceLoop();             //  ..  again which will trigger another 
        }else{
//            exit(); 
     ...
     function MyQuoteService(mySelection){
        setMyQuote("" + mySelection);
     }
     ...
     return(
        <View>
            ...
            <Text style ={{color:'gold', width: 300, height:150, textAlign:'center', fontSize:50, fontWeight: 'bold',}}>
